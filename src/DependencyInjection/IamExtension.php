<?php 
namespace OSW3\Iam\DependencyInjection;
...
class IamExtension extends Extension implements PrependExtensionInterface 
{
	/**
	...
	public function prepend(ContainerBuilder $container)
    {
        ...
        $twigConfig = [];
		$this->extendsTwigConfig($twigConfig, Path::join(__DIR__, "/../../", "templates"), "Iam");
